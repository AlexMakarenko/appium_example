...
class BasePage:
    ...
    def wait_text_of_element(
        self, driver, locator: tuple, text: str, time_to_wait: int = _default_wait
    ):
        return WebDriverWait(driver, time_to_wait).until(
